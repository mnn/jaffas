...
public class RenderUtils
{
    ...
    public static void addVertexWithTransform(double x, double y, double z, double u, double v, ITransformation t, IUVTransformation ut)
    {
    ...
    public static void renderBlock(Cuboid6 c, int sideMask, Vector3 pos, IUVTransformation u)
    {
        double x1 = c.min.x;
        double x2 = c.max.x;
        double y1 = c.min.y;
        ...
        ITransformation t = pos.translation();
        
        if((sideMask&1) == 0)
        {
            u1 = x1; v1 = z1;
            u2 = x2; v2 = z2;
            addVertexWithTransform(x1, y1, z2, u1, v2, t, u);
            addVertexWithTransform(x1, y1, z1, u1, v1, t, u);
            addVertexWithTransform(x2, y1, z1, u2, v1, t, u);
            addVertexWithTransform(x2, y1, z2, u2, v2, t, u);
        }
        ...
        if((sideMask&2) == 0)
        {
            u1 = x1+2; v1 = z1;
            u2 = x2+2; v2 = z2;
            addVertexWithTransform(x2, y2, z2, u2, v2, t, u);
            addVertexWithTransform(x2, y2, z1, u2, v1, t, u);
            addVertexWithTransform(x1, y2, z1, u1, v1, t, u);
            addVertexWithTransform(x1, y2, z2, u1, v2, t, u);
        }
        ...
        if((sideMask&4) == 0)
        {
            u1 = 1-x1+4; v1 = 1-y2;
            u2 = 1-x2+4; v2 = 1-y1;
            addVertexWithTransform(x1, y1, z1, u1, v2, t, u);
            addVertexWithTransform(x1, y2, z1, u1, v1, t, u);
            addVertexWithTransform(x2, y2, z1, u2, v1, t, u);
            addVertexWithTransform(x2, y1, z1, u2, v2, t, u);
        }
        ...
        if((sideMask&8) == 0)
        {
            ...
            u2 = x2+6; v2 = 1-y1;
            addVertexWithTransform(x2, y1, z2, u2, v2, t, u);
            addVertexWithTransform(x2, y2, z2, u2, v1, t, u);
            addVertexWithTransform(x1, y2, z2, u1, v1, t, u);
            addVertexWithTransform(x1, y1, z2, u1, v2, t, u);
        }
        ...
        if((sideMask&0x10) == 0)
        {
            u1 = z1+8; v1 = 1-y2;
            u2 = z2+8; v2 = 1-y1;
            addVertexWithTransform(x1, y1, z2, u2, v2, t, u);
            addVertexWithTransform(x1, y2, z2, u2, v1, t, u);
            addVertexWithTransform(x1, y2, z1, u1, v1, t, u);
            addVertexWithTransform(x1, y1, z1, u1, v2, t, u);
        }
        ...
        if((sideMask&0x20) == 0)
        {
            u1 = 1-z1+10; v1 = 1-y2;
            u2 = 1-z2+10; v2 = 1-y1;
            addVertexWithTransform(x2, y1, z1, u1, v2, t, u);
            addVertexWithTransform(x2, y2, z1, u1, v1, t, u);
            addVertexWithTransform(x2, y2, z2, u2, v1, t, u);
            addVertexWithTransform(x2, y1, z2, u2, v2, t, u);
        }
    }
