...
public class ItemInfo
{
    ...
    public static final HashMap<Integer, ArrayList<IHighlightIdentifier>> highlightIdentifiers = new HashMap<Integer, ArrayList<IHighlightIdentifier>>();
    ...
    private static void searchItems()
    {
        ...
        for(CreativeTabs tab : CreativeTabs.creativeTabArray)
        {
            if(creativeTabRanges[tab.getTabIndex()].ranges.size() > 0)
                API.addSetRange("CreativeTabs."+tab.getTranslatedTabLabel(), creativeTabRanges[tab.getTabIndex()]);
        }
    }
    ...
    public static ArrayList<ItemStack> getIdentifierItems(World world, EntityPlayer player, MovingObjectPosition hit)
    {
        ...
        ArrayList<IHighlightIdentifier> handlers = new ArrayList<IHighlightIdentifier>();
