...
public class FireworkRecipeHandler extends ShapelessRecipeHandler
{
    public String[] tooltips = new String[]{
            "Dyes add colours to the charges",
            "Recolouring adds fade colours to the charge",
            "Multiple charges can be spawned from one rocket"};
    ...
    public List<String> handleTooltip(GuiRecipe gui, List<String> currenttip, int recipe)
    {
        ...
        if(currenttip.isEmpty() && gui.manager.getStackMouseOver() == null && 
            ...
            currenttip.add(tooltips[((CachedFireworkRecipe)arecipes.get(recipe)).recipeType]);
        return currenttip;
    }
}
