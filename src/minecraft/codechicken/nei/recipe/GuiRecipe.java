...
public abstract class GuiRecipe extends GuiContainer implements IGuiContainerOverlay
{
    ...
    public void refreshPage()
    {
        ...
        overlay2.drawButton = handler.recipiesPerPage() == 2 && page * handler.recipiesPerPage() + 1 < handler.numRecipes() && handler.hasOverlay(mainInv, mainInv.inventorySlots, page * handler.recipiesPerPage() + 1);
    }
    ...
    private void refreshSlots()
    {
        ...
        for(int i = page * recipehandler.recipiesPerPage(); i < recipehandler.numRecipes() && i < (page + 1) * recipehandler.recipiesPerPage(); i++)
        {
            ...
            ArrayList<PositionedStack> stacks = recipehandler.getIngredientStacks(i);
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        s = "Page "+(page+1)+"/"+((currenthandlers.get(recipetype).numRecipes()-1) / recipehandler.recipiesPerPage() + 1);
        ...
        for(int i = page * recipehandler.recipiesPerPage(); i < recipehandler.numRecipes() && i < (page + 1) * recipehandler.recipiesPerPage(); i++)
        {
            recipehandler.drawForeground(manager, i);
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int mx, int my)
    {
        ...
        for(int i = page * recipehandler.recipiesPerPage(); i < recipehandler.numRecipes() && i < (page + 1) * recipehandler.recipiesPerPage(); i++)
        {
            recipehandler.drawBackground(manager, i);
            GL11.glTranslatef(0, 65, 0);
        }
        GL11.glPopMatrix();
    }
