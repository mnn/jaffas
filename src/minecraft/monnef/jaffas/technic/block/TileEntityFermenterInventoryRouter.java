...
public class TileEntityFermenterInventoryRouter extends TileEntity implements IInventory, ISidedInventory {
    private TileEntityFermenter master;

    public TileEntityFermenter getMaster() {
        if (master == null) {
            master = (TileEntityFermenter) worldObj.getBlockTileEntity(xCoord, yCoord - 1, zCoord);
        }
