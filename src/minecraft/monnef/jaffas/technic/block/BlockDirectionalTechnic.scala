...
class BlockDirectionalTechnic(_id: Int, _textureStart: Int, _texturesCountPerSet: Int, _material: Material, _type: BlockJDirectional.TextureMappingType, _textureSetsCount: Int) extends
BlockJDirectional(_id, _textureStart, _texturesCountPerSet, _material, _type, _textureSetsCount) with IconDescriptorTechnic {
