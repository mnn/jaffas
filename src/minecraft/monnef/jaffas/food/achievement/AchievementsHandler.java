...
public class AchievementsHandler {
    ...
    static HashMap<Integer, Achievement> craftAchievement = new HashMap<Integer, Achievement>();
    ...
    public static void init() {
        ...
        AchievementsCraftingHandler craftingHandler = new AchievementsCraftingHandler();
