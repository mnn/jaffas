...
public enum JaffaItem {
    ...
    pastry, milkBoxEmpty, milkBoxFull, crumpledPaper, scrap, chipsRaw, chips, fryingPanChipsRaw, fryingPanChips, pieStrawberryRaw, pieRaspberryRaw, pieVanillaRaw, piePlumRaw, _last
}
