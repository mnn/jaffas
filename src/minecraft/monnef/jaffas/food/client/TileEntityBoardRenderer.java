...
public class TileEntityBoardRenderer extends TileEntitySpecialRenderer {
    ...
    public TileEntityBoardRenderer() {
        board = new ModelBoard();
    }

    public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8) {
        renderModelAt((TileEntityBoard) tile, par2, par4, par6, par8);
    }

    public void renderModelAt(TileEntityBoard tile, double par2, double par4, double par6, float par8) {
