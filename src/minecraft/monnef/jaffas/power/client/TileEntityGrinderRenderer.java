...
public class TileEntityGrinderRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8) {
        renderModelAt((TileEntityGrinder) tile, par2, par4, par6, par8);
    }

    public void renderModelAt(TileEntityGrinder tile, double x, double y, double z, float par8) {
        ...
        bindTextureByName("/jaffas_grinder.png");
