...
public class TileEntityToasterRenderer extends TileEntitySpecialRenderer {
    ...
    public TileEntityToasterRenderer() {
        toaster = new ModelToaster();
    }

    public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8) {
        renderModelAt((TileEntityToaster) tile, par2, par4, par6, par8);
    }

    public void renderModelAt(TileEntityToaster tile, double x, double y, double z, float par8) {
