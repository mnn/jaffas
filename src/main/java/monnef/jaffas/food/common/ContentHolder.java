...
public class ContentHolder {
    ...
    */
    ...
    public static void createFluids() {
        ...
        blockCorrosiveGoo.setIsPoisonous();
        ...
        blockMiningGoo.setIsPoisonous().setHasMiningBonus();
        ...
        blockUnstableGoo.setIsPoisonous().setDoesBurn();
