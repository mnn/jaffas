...
public class RenderJaffaPainting extends Render {
    ...
    public void func_77009_a(EntityJaffaPainting par1EntityPainting, double par2, double par4, double par6, float par8, float par9) {
        EnumJaffaArt var10 = par1EntityPainting.art;
        if (var10 == null) {
            return;
        }
    ...
    private void func_77010_a(EntityJaffaPainting par1EntityPainting, int par2, int par3, int par4, int par5) {
    ...
    private void func_77008_a(EntityJaffaPainting par1EntityPainting, float par2, float par3) {
